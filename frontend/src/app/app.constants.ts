...
// In locale senza Docker: ng serve → http://bugboard.prizm.it:4200 → proxied a 8080
// In Docker locale: build con API_URL=http://bugboard.prizm.it:8080/api
